...
export default function DeviderBanner() {
  return (
    <div className="flex items-center justify-between bg-gradient-to-r from-black/90 to-black/30 p-8 rounded-lg text-white max-w-5xl mx-auto">
      ...
      {/* Right side - image */}
      <div className="w-[660px] h-[300px] flex-shrink-0">
        <Image
          height={100}
          width={100}
          src="/ee9925c6-744c-41f0-b1a3-5643fb8be512.png"
          alt="Water purifier"
          className="rounded-lg shadow-lg flex float-end"
        />
      </div>
    </div>
  );
